...
const enTranslations: Translations = {
    ...
    photoStyleCreator: {
      ...
      thumbnailMusic: {
        ...
        themePromptLabel: "1. Enter Theme or Upload Inspiration:",
        themePromptPlaceholder: "e.g., 80s retro wave, sports car at sunset",
        uploadImage: "Upload Image:",
        useAsInspiration: "Use as inspiration for AI",
        generateAIBg: "Create AI Background",
        ...
        aiTextStyleLabel: "2. Match Text Style to Theme:",
        generateAITextStyle: "Create AI Text Style",
        titleFontSize: "Max Title Font Size:",
        songsFontSize: "Song List Font Size:",
        titleFont: "Title Font:",
        songsFont: "Song List Font:",
        songsColor: "Song List Color:",
        titleEffects: "Title Text Effects",
        ...
        songColumns: "Song Columns:",
        canvasBgColor: "Canvas BG Color (if no image):",
        "alignLeft": "Left",
        "alignCenter": "Center",
        "alignRight": "Right",
        "oneColumn": "1 Column",
        ...
        "generatingBg": "AI is creating the image...",
        "generatingStyle": "AI is designing text styles...",
        "analyzing": "AI is analyzing inspiration...",
        "errorTheme": "Please enter a theme description first.",
        "downloadHD": "Download HD (<2MB)",
        "clear": "Clear"
      }
    },
    affiliateCreator: {
...
const idTranslations: Translations = mergeDeep(JSON.parse(JSON.stringify(enTranslations)), {
    ...
    photoStyleCreator: {
      ...
      thumbnailMusic: {
        ...
        normal: "Biasa",
        music: "Musik",
        aiCreation: "✨ Kreasi AI",
        themePromptLabel: "1. Masukkan Tema atau Unggah Inspirasi:",
        themePromptPlaceholder: "Contoh: 80s retro wave, mobil sport di senja hari",
        uploadImage: "Unggah Gambar:",
        useAsInspiration: "Jadikan inspirasi untuk AI",
        generateAIBg: "Buat Latar Belakang AI",
        ...
        aiTextStyleLabel: "2. Sesuaikan Gaya Teks dengan Tema:",
        generateAITextStyle: "Buat Gaya Teks AI",
        titleFontSize: "Ukuran Maks. Font Judul:",
        songsFontSize: "Ukuran Font Lagu:",
        titleFont: "Font Judul:",
        songsFont: "Font Lagu:",
        songsColor: "Warna Daftar Lagu:",
        titleEffects: "Efek Teks Judul",
        useGradient: "Gunakan Gradien",
        gradientStart: "Warna Awal",
        gradientEnd: "Warna Akhir",
        titleColor: "Warna Judul:",
        useShadow: "Gunakan Bayangan",
        shadowColor: "Warna Bayangan",
        shadowBlur: "Blur",
        layoutSettings: "Pengaturan Layout",
        titlePosition: "Posisi Judul:",
        songColumns: "Jumlah Kolom Lagu:",
        canvasBgColor: "Warna Latar Kanvas (Jika tidak ada gambar):",
        "alignLeft": "Kiri",
        "alignCenter": "Tengah",
        "alignRight": "Kanan",
        "oneColumn": "1 Kolom",
        "twoColumns": "2 Kolom",
        "fourColumns": "4 Kolom",
        "generatingBg": "AI sedang membuat gambar...",
        "generatingStyle": "AI sedang merancang gaya teks...",
        "analyzing": "AI sedang menganalisis inspirasi...",
        "errorTheme": "Silakan masukkan deskripsi tema dahulu.",
        "downloadHD": "Unduh HD (<2MB)",
        "clear": "Bersihkan"
      }
    },
    affiliateCreator: {
